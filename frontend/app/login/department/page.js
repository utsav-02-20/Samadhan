        ...
        <section className="relative hidden overflow-hidden bg-slate-950 lg:flex">
          ...
          <div className="relative flex w-full flex-col justify-between p-12 xl:p-16">
            ...
            <div className="max-w-lg">
              ...
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-white/10 text-violet-300 ring-1 ring-white/10">
                <Building2 className="h-7 w-7" />
              </div>

              <p className="mt-8 text-sm font-bold uppercase tracking-[0.2em] text-violet-300">
                Department Portal
              </p>

              <h1 className="mt-4 text-5xl font-black leading-tight tracking-[-0.04em] text-white xl:text-6xl">
                From assigned challenges to real-world impact.
              </h1>

              <p className="mt-6 max-w-md text-base leading-7 text-slate-400">
                Manage challenges assigned to your department, coordinate
                projects and keep implementation progress visible.
              </p>

              <div className="mt-10 space-y-4">

                <Feature text="Manage assigned challenges" />

                <Feature text="Coordinate department projects" />

                <Feature text="Track implementation progress" />
        ...
        <section className="flex items-center justify-center px-6 py-10 sm:px-10">
          ...
          <div className="w-full max-w-md">
            ...
            <div className="mt-10 lg:mt-0">
              ...
              <p className="mt-7 text-sm font-bold uppercase tracking-[0.18em] text-violet-600">
                Department
              </p>
              ...
              <p className="mt-3 text-sm leading-6 text-slate-500">
                Access assigned challenges, projects and department
                management tools.
              </p>
            ...
            <form onSubmit={handleSubmit} className="mt-8 space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className="h-12 w-full rounded-xl border border-slate-200 bg-white px-4 text-sm outline-none transition placeholder:text-slate-400 focus:border-violet-500 focus:ring-4 focus:ring-violet-500/10"
                />
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    required
                    className="h-12 w-full rounded-xl border border-slate-200 bg-white px-4 pr-12 text-sm outline-none transition placeholder:text-slate-400 focus:border-violet-500 focus:ring-4 focus:ring-violet-500/10"
                  />
            ...
            <div className="mt-8 flex items-start gap-3 rounded-2xl border border-slate-200 bg-white p-4">
              ...
              <p className="text-xs leading-5 text-slate-500">
                Department accounts are intended for authorized personnel.
                Your permissions will be verified by the backend.
              </p>
