...
const roles = [
  {
    title: "Citizen",
    description:
      "Create a citizen account to report civic issues, track complaints and participate in community initiatives.",
          ...
          <div className="w-full max-w-6xl">
            <div className="mx-auto max-w-3xl text-center">
              ...
              <p className="mx-auto mt-5 max-w-2xl text-base leading-7 text-slate-500 sm:text-lg">
                Select the type of account you want to create. Every role gets a
                dedicated workspace with features designed for its
                responsibilities.
              </p>
            </div>
            ...
            <div className="mx-auto mt-10 flex max-w-xl items-center justify-center gap-3 rounded-2xl border border-slate-200/80 bg-white/80 px-5 py-4 text-center shadow-sm backdrop-blur">
              ...
              <p className="text-xs leading-5 text-slate-500">
                All accounts are securely authenticated using Clerk. After
                registration, you'll complete your role-specific profile.
              </p>
            </div>
